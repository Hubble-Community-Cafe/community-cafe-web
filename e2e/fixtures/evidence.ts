...
/**
 * Helpers for attaching curated, human-readable evidence to the HTML report, so a passing
 * run shows positive proof of each flow (not just a green check), and a failing run captures
 * the exact UI state at the point of interest.
 */
...
/** Attach an object as pretty JSON (e.g. an API snapshot). */
